...
export function systemPrompt(): string {
  return [
    ...
    "<longcat_arg_value>exact text to replace</longcat_arg_value>",
    "<longcat_arg_key>new</longcat_arg_key>",
    "<longcat_arg_value>replacement text</longcat_arg_value>",
    "</longcat_tool_call>",
    ...
    "Prefer Edit over Write for small changes to existing files. Edit only succeeds when old text matches exactly once.",
    ...
    "</longcat_tool_call>",
    "Use only these tool names: Read, Write, Edit, Delete, List, Bash.",
